...
public class BrickerGameManager extends GameManager{
    ...
    private static final float BALL_SPEED = 280;
    ...
    private void createNumericLifeCounter() {
        ...
        gameObjects().addGameObject(numericLife, Layer.BACKGROUND);//todo UI
    }
    ...
    private void createGraphicLifeCounter() {
        ...
        GameObject graphicLife = new GraphicLifeCounter(new Vector2(BORDER_WIDTH + ONE,
                windowDimensions.y()- DIST), new Vector2(20,20), this.livesCounter,
                graphicLifeImage, gameObjects(), LIVES_START);
        gameObjects().addGameObject(graphicLife, Layer.BACKGROUND); //todo UI
    }
...
//        RectangleRenderable rectangleRenderable = new RectangleRenderable(Color.BLACK);
        ...
        GameObject upBorder = new GameObject(Vector2.ZERO, new Vector2(windowDimensions.x() - 5,
                (float) BORDER_WIDTH),null); //todo check -5
