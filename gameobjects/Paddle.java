...
public class Paddle extends GameObject {
    ...
    public static final int MOVE_SPEED = 500; //todo - public or private
    ...
    public void update(float deltaTime) {
        ...
        transform().setTopLeftCornerX(Math.min(getTopLeftCorner().x(),
                this.windowDimensions.x() - this.minDistFromEdge - getDimensions().x()));
        transform().setTopLeftCornerX(Math.max(getTopLeftCorner().x(), this.minDistFromEdge));
    }
}